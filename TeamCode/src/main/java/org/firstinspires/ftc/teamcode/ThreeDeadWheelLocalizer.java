...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2012.193413628318; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1804.2937697519244; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -3160.6323706328176; // x position of the perpendicular encoder (in tick units)
    }
...
//cccbkrlbbhlvjlbbnddruiknekbllrffuhtrjvtuhk
